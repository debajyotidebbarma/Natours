...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWVvd3lwaG9lbml4IiwiYSI6ImNrbzkzZnNhYzBxMHMyd211bXB4dXdqdGcifQ.aGrXdRpeV4b6auWhDamLyA';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>".concat(loc.description, "</p>")).addTo(map); // Extends the map bounds to include the current location
...
var stripe = Stripe('pk_test_51Ir3uGSHdBg3oT4Xu03TJblAzMmU8WIKkAcvsYnApJ0PKFnqSi1DnYrlfhCnD1SGY62FQTfDhLLI8G9QFifOizfI00lvNo2RI7');
